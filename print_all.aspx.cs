...
public partial class print_all : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            if (!String.IsNullOrEmpty(Convert.ToString(Request.QueryString["p_id"])))
            {
                ...
                {
                    TextBox1.Text = f4.r_other_name.ToString();
                }
                ...
                CheckBoxList1.Items[0].Selected = Convert.ToBoolean(f5.r_Patientsick_ck);
                CheckBoxList1.Items[1].Selected = Convert.ToBoolean(f5.r_Followup_routine_ck);
                CheckBoxList1.Items[2].Selected = Convert.ToBoolean(f5.r_Followup_after_exacerbation_ck);
                CheckBoxList1.Items[3].Selected = Convert.ToBoolean(f5.r_other_ck);
                ...
                {
                    TextBox2.Text = f5.r_other_name.ToString();
                }
