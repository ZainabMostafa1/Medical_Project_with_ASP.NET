<%@ Page Language="C#" AutoEventWireup="true" CodeFile="print_pg.aspx.cs" Inherits="print_pg" %>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-12">
                                                        <div class="form-group">
                                                            ...
                                                            <asp:TextBox runat="server" ID="medication_tx" ClientIDMode="Static" TextMode="MultiLine" CssClass="form-control"></asp:TextBox>
                                                            <asp:RequiredFieldValidator
                                                    ...
                                                    <div class="col-12 form-group" runat="server" id="div_hospitals" visible="false">
                                                        <div class="form-control">
                                                            ...
                                                            <div class="col-12" id="other_hospital_div" runat="server" visible="false">
                                                                <div class="form-group">
                                                                    <label >other:</label>
                                                                    <asp:TextBox runat="server" ID="other_hospital_tx" ClientIDMode="Static" CssClass="form-control"></asp:TextBox>
                                                                    <%-- <asp:RequiredFieldValidator
                                                    ...
                                                    <div class="col-12" id="other_iv_div" runat="server" visible="false">
                                                        <div class="form-group">
                                                            <label>Other:</label>
                                                            <asp:TextBox runat="server" ID="other_iv_tx" ClientIDMode="Static" CssClass="form-control"></asp:TextBox>
                                                           <%-- <asp:RequiredFieldValidator
                                                    ...
                                                    <div class="col-12 form-group">
                                                        <div class="form-control">
                                                            ...
                                                            <div class="col-12" id="other_source_div" runat="server" visible="false">
                                                                <div class="form-group">
                                                                    <label>other:</label>
                                                                    <asp:TextBox runat="server" ID="other_source_tx" ClientIDMode="Static" CssClass="form-control"></asp:TextBox>
                                                                    <%-- <asp:RequiredFieldValidator
                                                                CssClass=" form-control-color alert-danger text-bold list-group-item-text" runat="server" ValidationGroup='b' ID="RequiredFieldValidator13" ControlToValidate="days_hospital_tx" ErrorMessage="enter days of hospitalization ">
                                                            </asp:RequiredFieldValidator>--%>
                                                                </div>
                                                    ...
                                                    <div class="col-12 form-group">
                                                        <div class="form-control">
                                                            ...
                                                            <div class="col-12" id="other_micro_div" runat="server">
                                                                <div class="form-group">
                                                                    <label>other:</label>
                                                                    <asp:TextBox runat="server" ID="other_micro_tx" ClientIDMode="Static" CssClass="form-control"></asp:TextBox>
                                                                    <%-- <asp:RequiredFieldValidator
                                                                CssClass=" form-control-color alert-danger text-bold list-group-item-text" runat="server" ValidationGroup='b' ID="RequiredFieldValidator13" ControlToValidate="days_hospital_tx" ErrorMessage="enter days of hospitalization ">
                                                            </asp:RequiredFieldValidator>--%>
                                                                </div>
                                                    ...
                                                    <div class="col-12 form-group">
                                                        <div class="form-control">
                                                            ...
                                                            <div class="col-12" id="other_mycobacterial_div" runat="server" visible="false">
                                                                <div class="form-group">
                                                                    <label>other:</label>
                                                                    <asp:TextBox runat="server" ID="other_mycobacterial_tx" ClientIDMode="Static" CssClass="form-control"></asp:TextBox>
                                                                    <%-- <asp:RequiredFieldValidator
                                                                CssClass=" form-control-color alert-danger text-bold list-group-item-text" runat="server" ValidationGroup='b' ID="RequiredFieldValidator13" ControlToValidate="days_hospital_tx" ErrorMessage="enter days of hospitalization ">
                                                            </asp:RequiredFieldValidator>--%>
                                                                </div>
                                                    ...
                                                    <div class="col-12 form-group">
                                                        <div class="form-control">
                                                            ...
                                                            <div class="col-12" id="other_myco_culture_div" runat="server">
                                                                <div class="form-group">
                                                                    <label>other:</label>
                                                                    <asp:TextBox runat="server" ID="other_myco_culture_tx" ClientIDMode="Static" CssClass="form-control"></asp:TextBox>
                                                                    <%-- <asp:RequiredFieldValidator
                                                                CssClass=" form-control-color alert-danger text-bold list-group-item-text" runat="server" ValidationGroup='b' ID="RequiredFieldValidator13" ControlToValidate="days_hospital_tx" ErrorMessage="enter days of hospitalization ">
                                                            </asp:RequiredFieldValidator>--%>
                                                                </div>
                                                    ...
                                                    <div class="col-12 form-group">
                                                        <div class="form-control">
                                                           ...
                                                           <div class="col-12">
                                                                <div class="form-group">
                                                                    <label>Others:</label>
                                                                    <asp:TextBox runat="server" TextMode="MultiLine" ID="other_tx" ClientIDMode="Static" CssClass="form-control"></asp:TextBox>
                                                                    <%-- <asp:RequiredFieldValidator
                                                                CssClass=" form-control-color alert-danger text-bold list-group-item-text" runat="server" ValidationGroup='b' ID="RequiredFieldValidator13" ControlToValidate="days_hospital_tx" ErrorMessage="enter days of hospitalization ">
                                                            </asp:RequiredFieldValidator>--%>
                                                                </div>
                                                    ...
                                                    <div class="col-12 form-group">
                                                        <div class="form-control">
                                                            ...
                                                            <div class="col-12">
                                                                <div class="form-group">
                                                                    <label>Other:</label>
                                                                    <asp:TextBox runat="server" TextMode="MultiLine" ID="TextBox1" ClientIDMode="Static" CssClass="form-control"></asp:TextBox>
                                                                    <%-- <asp:RequiredFieldValidator
                                                                CssClass=" form-control-color alert-danger text-bold list-group-item-text" runat="server" ValidationGroup='b' ID="RequiredFieldValidator13" ControlToValidate="days_hospital_tx" ErrorMessage="enter days of hospitalization ">
                                                            </asp:RequiredFieldValidator>--%>
                                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-12 form-group">
                                                        <div class="form-control">
                                                            ...
                                                            <div class="col-12">
                                                                <div class="form-group">
                                                                    <label>Other:</label>
                                                                    <asp:TextBox runat="server" TextMode="MultiLine" ID="TextBox2" ClientIDMode="Static" CssClass="form-control"></asp:TextBox>
                                                                    <%-- <asp:RequiredFieldValidator
                                                                CssClass=" form-control-color alert-danger text-bold list-group-item-text" runat="server" ValidationGroup='b' ID="RequiredFieldValidator13" ControlToValidate="days_hospital_tx" ErrorMessage="enter days of hospitalization ">
                                                            </asp:RequiredFieldValidator>--%>
                                                                </div>
                                                    ...
                                                    <div class="col-12">
                                                        <div class="form-group">
                                                            ...
                                                            <asp:TextBox runat="server" ID="CXR_Findings_tx" TextMode="MultiLine" ClientIDMode="Static" CssClass="form-control"></asp:TextBox>
                                                            <%-- <asp:RequiredFieldValidator
                                                                CssClass=" form-control-color alert-danger text-bold list-group-item-text" runat="server" ValidationGroup='b' ID="RequiredFieldValidator13" ControlToValidate="days_hospital_tx" ErrorMessage="enter days of hospitalization ">
                                                            </asp:RequiredFieldValidator>--%>
                                                        </div>
                                                        ...
                                                        <div class="form-control">
                                                            <div class="col-12">
                                                                <div class="form-group">
                                                                    ...
                                                                    <asp:TextBox runat="server" ID="CT_Findings_tx" TextMode="MultiLine" ClientIDMode="Static" CssClass="form-control"></asp:TextBox>
                                                                    <%-- <asp:RequiredFieldValidator
                                                                CssClass=" form-control-color alert-danger text-bold list-group-item-text" runat="server" ValidationGroup='b' ID="RequiredFieldValidator13" ControlToValidate="days_hospital_tx" ErrorMessage="enter days of hospitalization ">
                                                            </asp:RequiredFieldValidator>--%>
                                                                </div>
                                                            ...
                                                            <div class="col-12">
                                                                <div class="form-group">
                                                                    ...
                                                                    <asp:TextBox runat="server" ID="OtherFindings_tx" TextMode="MultiLine" ClientIDMode="Static" CssClass="form-control"></asp:TextBox>
                                                                    <%-- <asp:RequiredFieldValidator
                                                                CssClass=" form-control-color alert-danger text-bold list-group-item-text" runat="server" ValidationGroup='b' ID="RequiredFieldValidator13" ControlToValidate="days_hospital_tx" ErrorMessage="enter days of hospitalization ">
                                                            </asp:RequiredFieldValidator>--%>
                                                                </div>
